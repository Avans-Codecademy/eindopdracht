...
public class Module extends ContentItem{
    ...
    public Module(int contentItemid, LocalDate publishDate, Status status, String title, String description, String emailContactPerson, String nameContactPerson, double version, int orderNumber) {
    ...
    public void setOrderNumber(int orderNummer) {
